...
let masVotadas = movies.map((movie)=>{
...
let votadas = movies.filter((movie)=>{ //no usar nunca mas map, ni forEach >:v
    return movie.vote_average >= 7
        
        
})

console.log('mas votadas:' + masVotadas.length);
console.log('votadas' + votadas.length);